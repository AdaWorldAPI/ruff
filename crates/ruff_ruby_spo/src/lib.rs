...
pub use menu_regions::{
    Position, RegionEntry, RegionScanReport, extract_regions, extract_regions_with_report,
};
pub use navigation::{
...
pub use widgets::{
    RubyWidgetEdge, WidgetKind, WidgetScanReport, extract_widget_edges,
    extract_widget_edges_with_report,
};
