...
mod tests {
    ...
    #[test]
    #[allow(clippy::print_stderr)] // diagnostic emission gated on env var (real-corpus gate)
    #[allow(clippy::items_after_statements)] // nested `expected_address` helper is scoped to this test body
    fn corpus_probe_menu_quad_round_trip_over_openproject() {
        ...
        // behavior-preserving: iteration order not relied upon here
